    ...
    <Container style={{ margin: "0px", padding: "0px", height: "auto" }} fluid>
      ...
      <Row xs={12} lg={12} md={12} sm={12}>
        <Col xs={12} lg={7} md={7} sm={12}>
          ...
          >
            <Table className="tableinside" >
              ...
              >
                ...
                <tr>
                  <td style={{ textAlign: "left", color: "#000000A6", paddingLeft: "10px" }}>Name</td>
                  <td style={{ textAlign: "center", color: "#000000A6", padding: "12px 10px" }}>Employee Id</td>
                  <td style={{ textAlign: "right", color: "#000000A6", paddingRight: "15px" }}>Profile</td>
                </tr>
              </thead>
              <tbody
                style={{
              ...
              >
                {employeeList.slice(0, showAll ? employeeList.length : 4).map((faculty, index) => (
                  <tr key={index}>
                    <td style={{ textAlign: "left", color: "#000000A6", padding: "12px 10px" }}>{faculty.Name}</td>
                    <td style={{ textAlign: "center", color: "#000000A6", padding: "12px 10px" }}>{faculty.EmployeeID}</td>
                    <td style={{ textAlign: "right", color: "#000000A6", paddingRight: "15px" }}>{faculty.Profile}</td>
                  </tr>
                ))}
          ...
          {/* Open position */}
          <Row xs={12} className=" row2c" style={row2c}>
        ...
        <Col xs={12} sm={12} md={5} lg={5}>
          ...
          <Row className="row4c" style={row4c}>
            <Row className="my-2" xs={12} lg={12}>
              ...
              <Col className="mr-0 p-0" xs={3} lg={2} md={4}>
                <span
                  style={{
                    fontSize: "15px",
                    fontWeight: "400px !important",
