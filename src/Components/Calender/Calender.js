    ...
    <Container className="calender my-2 p-0" fluid>
          ...
          <Col xs={4} lg={4} md={4} sm={4}>
            ...
            <Row xs={12} sm={12} md={12} lg={12}>
              ...
              >
                <FontAwesomeIcon
                  icon={faArrowLeft}
                  style={{ color: "#006EBE", width: "16.17px", height: "17px" }}
                />
              </Button>
              <Button
                variant="primary"
              ...
              >
                <FontAwesomeIcon
                  icon={faArrowRight}
                  style={{ color: "#FFFFFF", width: "16.17px", height: "17px" }}
                />
              </Button>
            </Row>
      ...
      <Row className="days-name" style={{ color: "white" }}>
        {dayNames.map((day) => (
          <Col
            ...
            md={1}
            lg={1}
            className="day-name text-center"
          >
            {day}
          </Col>
        ))}
      ...
      <Row className="days">
        {daysInMonth.map((day, index) => (
          ...
          >
            <div className="day-card">{day.getDate()}</div>
          </Col>
        ))}
      </Row>
    </Container>
